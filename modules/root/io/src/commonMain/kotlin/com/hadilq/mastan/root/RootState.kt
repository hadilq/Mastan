...
import com.hadilq.mastan.theme.MastanThemeState
...
data class RootState(
    ...
    val themeState: MastanThemeState,
)

val initRootState = RootState(
    authState = NoAuthState,
    navigationState = NavigationState(),
    themeState = MastanThemeState()
)
