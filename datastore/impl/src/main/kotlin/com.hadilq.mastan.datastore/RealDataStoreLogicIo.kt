...
class RealDataStoreLogicIo(
    ...
    /**
     * It's a single instance in [RealDataStoreLogicIo] scope.
     */
    override val mastanDataStore: MastanDataStore by logicTreeArchitecture.single {
        RealMastanDataStore(applicationContext, logger)
    }
}
